...
export class WellKnownMessage extends jspb.Message {
  ...
  clearMyCodeGeneratorRequest(): WellKnownMessage;
  ...
  clearMyGeneratedCodeInfo(): WellKnownMessage;
  ...
  clearMyDuration(): WellKnownMessage;
  ...
  clearMyFieldMask(): WellKnownMessage;
  ...
  clearMySourceContext(): WellKnownMessage;
  ...
  hasMyStruct(): boolean;
  clearMyStruct(): WellKnownMessage;
  ...
  clearMyTimestamp(): WellKnownMessage;
  ...
  clearMyDoubleValue(): WellKnownMessage;
