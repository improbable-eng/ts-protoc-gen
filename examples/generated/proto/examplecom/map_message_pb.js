// source: proto/examplecom/map_message.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.object.extend(proto, proto_othercom_external_enum_pb);
...
proto.examplecom.MapMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.examplecom.MapMessage.InternalChildMessage.deserializeBinaryFromReader, "", new proto.examplecom.MapMessage.InternalChildMessage());
         });
      break;
    case 3:
    ...
    case 4:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.othercom.ExternalChildMessage.deserializeBinaryFromReader, "", new proto.othercom.ExternalChildMessage());
         });
      break;
    case 5:
...
/**
 * @param {string} value
 * @return {!proto.examplecom.MapMessage.InternalChildMessage} returns this
 */
 ...
 * @return {!proto.examplecom.MapMessage} returns this
 */
