// source: proto/examplecom/parent_message_v3.proto
/**
 * @fileoverview
 * @enhanceable
...
/**
 * @param {string} value
 * @return {!proto.examplecom.ParentMessageV3.InternalChildMessage} returns this
 */
...
proto.examplecom.ParentMessageV3.prototype.clearInternalChildrenList = function() {
  return this.setInternalChildrenList([]);
};
...
proto.examplecom.ParentMessageV3.prototype.clearExternalChildrenList = function() {
  return this.setExternalChildrenList([]);
};
