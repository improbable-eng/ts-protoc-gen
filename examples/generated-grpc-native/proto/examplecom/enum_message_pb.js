// source: proto/examplecom/enum_message.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.examplecom.EnumMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    internalEnumsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
    externalEnum: jspb.Message.getFieldWithDefault(msg, 3, 0),
    externalEnumsList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f
  };
...
proto.examplecom.EnumMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var values = /** @type {!Array<!proto.examplecom.EnumMessage.InternalEnum>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addInternalEnums(values[i]);
      }
      break;
    case 3:
      ...
      break;
    case 4:
      var values = /** @type {!Array<!proto.othercom.ExternalEnum>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addExternalEnums(values[i]);
      }
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.examplecom.EnumMessage} returns this
 */
...
proto.examplecom.EnumMessage.prototype.clearInternalEnumsList = function() {
  return this.setInternalEnumsList([]);
};
...
proto.examplecom.EnumMessage.prototype.clearExternalEnumsList = function() {
  return this.setExternalEnumsList([]);
};
