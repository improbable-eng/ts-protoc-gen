// source: proto/examplecom/primitive_message_v2.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.examplecom.PrimitiveMessageV2.toObject = function(includeInstance, msg) {
  var f, obj = {
    myDouble: (f = jspb.Message.getOptionalFloatingPointField(msg, 1)) == null ? undefined : f,
    myFloat: (f = jspb.Message.getOptionalFloatingPointField(msg, 2)) == null ? undefined : f,
    myInt32: (f = jspb.Message.getField(msg, 3)) == null ? undefined : f,
    myInt64: (f = jspb.Message.getField(msg, 4)) == null ? undefined : f,
    myUint32: (f = jspb.Message.getField(msg, 5)) == null ? undefined : f,
    myUint64: (f = jspb.Message.getField(msg, 6)) == null ? undefined : f,
    mySint32: (f = jspb.Message.getField(msg, 7)) == null ? undefined : f,
    mySint64: (f = jspb.Message.getField(msg, 8)) == null ? undefined : f,
    myFixed32: (f = jspb.Message.getField(msg, 9)) == null ? undefined : f,
    myFixed64: (f = jspb.Message.getField(msg, 10)) == null ? undefined : f,
    mySfixed32: (f = jspb.Message.getField(msg, 11)) == null ? undefined : f,
    mySfixed64: (f = jspb.Message.getField(msg, 12)) == null ? undefined : f,
    myBool: (f = jspb.Message.getBooleanField(msg, 13)) == null ? undefined : f,
    myString: (f = jspb.Message.getField(msg, 14)) == null ? undefined : f,
    myBytes: msg.getMyBytes_asB64(),
    optDouble: (f = jspb.Message.getOptionalFloatingPointField(msg, 16)) == null ? undefined : f,
    optFloat: (f = jspb.Message.getOptionalFloatingPointField(msg, 17)) == null ? undefined : f,
    optInt32: (f = jspb.Message.getField(msg, 18)) == null ? undefined : f,
    optInt64: (f = jspb.Message.getField(msg, 19)) == null ? undefined : f,
    optUint32: (f = jspb.Message.getField(msg, 20)) == null ? undefined : f,
    optUint64: (f = jspb.Message.getField(msg, 21)) == null ? undefined : f,
    optSint32: (f = jspb.Message.getField(msg, 22)) == null ? undefined : f,
    optSint64: (f = jspb.Message.getField(msg, 23)) == null ? undefined : f,
    optFixed32: (f = jspb.Message.getField(msg, 24)) == null ? undefined : f,
    optFixed64: (f = jspb.Message.getField(msg, 25)) == null ? undefined : f,
    optSfixed32: (f = jspb.Message.getField(msg, 26)) == null ? undefined : f,
    optSfixed64: (f = jspb.Message.getField(msg, 27)) == null ? undefined : f,
    optBool: (f = jspb.Message.getBooleanField(msg, 28)) == null ? undefined : f,
    optString: (f = jspb.Message.getField(msg, 29)) == null ? undefined : f,
    optBytes: msg.getOptBytes_asB64(),
    optNumber: (f = jspb.Message.getField(msg, 31)) == null ? undefined : f
  };
...
/**
 * @param {number} value
 * @return {!proto.examplecom.PrimitiveMessageV2} returns this
 */
