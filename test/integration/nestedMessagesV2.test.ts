import {ParentMessageV2} from "../../examples/generated/proto/examplecom/parent_message_v2_pb";
...
describe("proto2 - internal nested messages", () => {
  it("should allow getting internal message fields on an empty message", () => {
    ...
    expect(parentMsg.getInternalChildMessage().getMyString() as string).toStrictEqual("");
  ...
  it("should allow setting and getting required internal message fields", () => {
    const parentMsg = new ParentMessageV2();
    expect(parentMsg.hasInternalChildMessage() as boolean).toStrictEqual(false);
    ...
    expect(parentMsg.hasInternalChildMessage() as boolean).toStrictEqual(true);
  ...
  it("should allow setting and getting optional internal message fields", () => {
    const parentMsg = new ParentMessageV2();
    expect(parentMsg.hasOptInternalChildMessage() as boolean).toStrictEqual(false);
    const childMsg = new InternalChildMessage();
    childMsg.setMyString("hello world");
    ...
    expect(parentMsg.hasOptInternalChildMessage() as boolean).toStrictEqual(true);
...
describe("proto2 - external nested messages", () => {
  it("should allow getting external message fields on an empty message", () => {
    const parentMsg = new ParentMessageV2();
    expect(parentMsg.getExternalChildMessage().getMyString() as string).toStrictEqual("");
  ...
  it("should allow setting and getting external message fields", () => {
    const parentMsg = new ParentMessageV2();
    expect(parentMsg.hasExternalChildMessage() as boolean).toStrictEqual(false);
    ...
    expect(parentMsg.hasExternalChildMessage() as boolean).toStrictEqual(true);
  ...
  it("should allow setting and getting optional external message fields", () => {
    const parentMsg = new ParentMessageV2();
    expect(parentMsg.hasOptExternalChildMessage() as boolean).toStrictEqual(false);
    const childMsg = new ExternalChildMessage();
    childMsg.setMyString("hello world");
    parentMsg.setOptExternalChildMessage(childMsg);
    expect(parentMsg.getOptExternalChildMessage()!.getMyString() as string).toStrictEqual("hello world");
    expect(parentMsg.hasOptExternalChildMessage() as boolean).toStrictEqual(true);
    parentMsg.setOptExternalChildMessage(undefined);
    expect(parentMsg.getOptExternalChildMessage() as undefined).toStrictEqual(undefined);
    expect(parentMsg.hasOptExternalChildMessage() as boolean).toStrictEqual(false);
...
describe("proto2 - toObject", () => {
  it("should have empty message fields if undefined", () => {
    ...
    expect(asObjectUnset.internalChildMessage as InternalChildMessage.AsObject).toStrictEqual({myString: undefined});
    const childMsg = new InternalChildMessage();
    childMsg.setMyString("hello world");
    parentMsg.setInternalChildMessage(childMsg);
  ...
  it("should indicate potentially undefined primitive fields", () => {
    ...
    expect(asObjectUnset.myString as string).toStrictEqual(undefined); // TODO
