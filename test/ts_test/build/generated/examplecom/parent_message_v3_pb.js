...
proto.examplecom.ParentMessageV3.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.examplecom.ParentMessageV3.prototype.getExternalChildMessage = function () {
    return /** @type{?proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, othercom_external_child_message_pb.ExternalChildMessage, 3));
};
...
proto.examplecom.ParentMessageV3.prototype.getExternalChildrenList = function () {
    return /** @type{!Array.<!proto.othercom.ExternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, othercom_external_child_message_pb.ExternalChildMessage, 4));
};
