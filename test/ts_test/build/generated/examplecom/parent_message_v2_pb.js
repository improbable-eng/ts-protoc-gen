...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.examplecom.ParentMessageV2.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            externalChildrenList: jspb.Message.toObjectList(msg.getExternalChildrenList(), othercom_external_child_message_pb.ExternalChildMessage.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.examplecom.ParentMessageV2.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(4, f, othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getOptExternalChildMessage();
    if (f != null) {
        writer.writeMessage(5, f, othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.examplecom.ParentMessageV2.prototype.getExternalChildMessage = function () {
    return /** @type{!proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, othercom_external_child_message_pb.ExternalChildMessage, 4, 1));
};
...
proto.examplecom.ParentMessageV2.prototype.getOptExternalChildMessage = function () {
    return /** @type{?proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, othercom_external_child_message_pb.ExternalChildMessage, 5));
};
...
proto.examplecom.ParentMessageV2.prototype.getExternalChildrenList = function () {
    return /** @type{!Array.<!proto.othercom.ExternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, othercom_external_child_message_pb.ExternalChildMessage, 6));
};
