...
import { ReservedWordsMessage } from "../../../examples/flow/generated/proto/examplecom/reserved_words_pb";
import { type ReservedWordsMessage$AsClass } from "../../../examples/flow/generated/proto/examplecom/reserved_words_pb.flow";
...
describe("reserved words", () => {
  ...
  describe("toObject", () => {
    ...
    it("should prefix reserved words with `pb_` in the type definition", () => {
      const msg: ReservedWordsMessage$AsClass = new ReservedWordsMessage();
      const asObject = msg.toObject();
